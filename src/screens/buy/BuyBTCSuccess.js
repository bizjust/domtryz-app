...
export default function BuyBTCSuccess({ route, navigation }) {
    ...
    <StatusBar style="auto" backgroundColor={"#e234e3"} />
      ...
      <ScrollView style={{ }}>
        ...
        <View style={{ alignItems: "center", paddingTop: 40 }}>
          <Text style={{ fontWeight: "bold", textAlign: 'center', marginBottom: 30, }} h4>
            You just exchanged 0.002563 BTC to buy $42 USD.
          </Text>
          <View
            style={{
              flexDirection: "row",
