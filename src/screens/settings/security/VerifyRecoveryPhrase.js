...
export default function VerifyRecoveryPhrase({ navigation }) {
      ...
      <ScrollView>
        ...
        >
          ...
          <View style={{ paddingVertical: 30 }}>
            <TouchableOpacity disabled={phraseOptions.length>0} onPress={()=>{ navigation.navigate("YourRecoveryPhrase", { phrase: phrase }); }} >
              <LinearGradient
                // Button Linear Gradient
                style={{
                  paddingVertical: 12,
