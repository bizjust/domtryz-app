    ...
    <StatusBar
      ...
      <View style={styles.fieldRow}>
        <CodeField
          ...
          {...props}
          value={value}
          onChangeText={(v)=>{ setValue(v); console.log(value); }}
...
const styles = StyleSheet.create({
    root: {padding: 20, minHeight: 300, backgroundColor: '#8C4BA8', height:height},
  title: {textAlign: 'center', fontSize: 18, fontWeight: 'bold', color: '#FFF', marginTop: 100,},
  fieldRow: {
    marginTop: 20,
    flexDirection: 'row',
    alignItems: 'center',
